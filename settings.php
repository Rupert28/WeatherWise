...
function weatherwise_settings_page()
{
    ...
    <div class="wrap">
        ...
        <p>Thanks for installing the WeatherWise WordPress Plugin!<br>To use the plugin, add the shortcode <b><code>[display_weather]</code></b>
        to your site and configure the options below.</p>
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr valign="top">
                    ...
                    <td>
                        <input type="text" name="weatherwise_settings[latitude]" value="<?php echo $latitude_value; ?>" />
                        <p class="description">Enter your desired latitude.</p>
                    </td>
                    <td>
                        <input type="text" name="weatherwise_settings[longitude]" value="<?php echo $longitude_value; ?>" />
            ...
            <table class="form-table">
                <tr valign="top">
                    ...
                    <td>
                        <input type="text" name="weatherwise_settings[display_location]" value="<?php echo $display_location; ?>" />
            ...
            <table class="form-table">
                <tr valign="top">
                    ...
                    <td>
                        <input type="text" name="weatherwise_settings[api_key]" value="<?php echo $api_key_value; ?>" />
                        <p class="description">To access the hourly forecast you'll need to subscribe 
                            ...
                            below this limit. Once you've subscribed to this service, enter your API key above.<br><a href='https://openweathermap.org/api/one-call-3'>
